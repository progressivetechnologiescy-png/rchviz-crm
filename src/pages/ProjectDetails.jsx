        ...
        <motion.div className="p-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <header className="project-header-container">
                <div className="project-header-left">
                    <button
                        className="flex items-center gap-2 text-sm text-[var(--text-primary)] bg-[var(--input-bg)] border border-[var(--glass-border)] rounded-lg cursor-pointer px-4 py-2 hover:bg-[var(--hover-bg)] hover:border-[var(--glass-border-highlight)] transition-all self-start"
                                ...
                                return (
                                    <div key={svc.id} className="flex flex-col gap-2 p-3 rounded-lg border border-[var(--glass-border)] bg-[var(--bg-secondary)]/50 transition-all">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="relative inline-flex items-center cursor-pointer" onPointerDown={(e) => {
                                                e.preventDefault();
                                                e.stopPropagation();
                                                ...
                                                <input type="checkbox" className="sr-only peer pointer-events-none" checked={current.selected} readOnly disabled={userRole === 'client'} tabIndex="-1" />
