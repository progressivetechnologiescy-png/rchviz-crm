        ...
        >
            <header className="page-header mb-8">
                <div>
                    ...
                    <p className="page-subtitle">Track project billing, deposits, and outstanding balances.</p>
                </div>
            </header>
            ...
            <div className="metrics-grid mb-8">
                <div className="metric-card glass-panel">
                    ...
                    <div className="metric-content">
                        <h3 className="metric-label">Total Pipeline Revenue</h3>
                ...
                <div className="metric-card glass-panel">
                    ...
                    <div className="metric-content">
                        <h3 className="metric-label">Deposits Collected</h3>
                ...
                <div className="metric-card glass-panel border-l-4 border-l-danger">
                    ...
                    <div className="metric-content">
                        <h3 className="metric-label">Outstanding Balances</h3>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setPaymentModal({ isOpen: false, project: null, amount: '' })}>
                        ...
                        >
                            ...
                            <form onSubmit={handlePaymentSubmit} className="p-5 space-y-4">
                                <div>
                                    <p className="text-sm text-[var(--text-secondary)] mb-1">Project: <span className="text-[var(--text-primary)] font-medium">{paymentModal.project?.name}</span></p>
                                    <p className="text-sm text-[var(--text-secondary)] mb-4">Current Balance: <span className="text-[var(--status-danger)] font-medium">€{Number(paymentModal.project?.balance)?.toLocaleString() || 0}</span></p>
                                </div>
                                <div className="space-y-1">
                                    <label className="text-xs text-secondary font-medium tracking-wide uppercase">Amount Received (€)</label>
                                    <input
                                        type="number"
                                        autoFocus
                                        required
                                ...
                                <div className="pt-2 flex gap-3">
                                    <button type="button" className="btn btn-ghost flex-1" onClick={() => setPaymentModal({ isOpen: false, project: null, amount: '' })}>Cancel</button>
                                    <button type="submit" className="btn btn-primary flex-1">Save Payment</button>
                                </div>
                            </form>
                        </motion.div>
                    </div>
